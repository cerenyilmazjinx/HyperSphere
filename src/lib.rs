...
#[derive(Debug)]
pub struct HyperSphereProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HyperSphereProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HyperSphere processing");
    
    let mut processor = HyperSphereProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HyperSphereProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HyperSphereProcessor::new(false);
